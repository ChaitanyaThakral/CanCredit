...
class TestMartRowCountSensor:
    ...
    def _make_sensor(self, table='DB.SCHEMA.TABLE', min_rows=1000, conn_id='snowflake_cancredit'):
        from snowflake_mart_sensor import MartRowCountSensor
        return MartRowCountSensor(task_id='test_sensor', table=table, min_rows=min_rows, conn_id=conn_id)
